...
function deleteSelectedRows(selectedRows, allRows, setSelected, setPage) {
  const newRows = allRows.filter((row) => !selectedRows.includes(row.id));
  setSelected([]);
  setPage(0);
  // Use 'newRows' to update your state or trigger any action for deleting rows.
  console.log("Deleted rows:", selectedRows);
  console.log("Remaining rows:", newRows);
}
